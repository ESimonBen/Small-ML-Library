...
TEST_SUITE("Serialization Tests") {
	TEST_CASE("Binary Archive Tests") {
		SUBCASE("Write and Read basic data to a file") {
			{
				std::ofstream out{ "C:/Develop/Small-ML-Library/MLTests/serialization/testFiles/test1.ckpt", std::ios::binary };
			...
			std::ifstream in{ "C:/Develop/Small-ML-Library/MLTests/serialization/testFiles/test1.ckpt", std::ios::binary };
		...
		SUBCASE("Write and Read an array/string to a file") {
			{
				std::ofstream out{ "C:/Develop/Small-ML-Library/MLTests/serialization/testFiles/test2.ckpt", std::ios::binary };
			...
			std::ifstream in{ "C:/Develop/Small-ML-Library/MLTests/serialization/testFiles/test2.ckpt", std::ios::binary };
		...
		SUBCASE("Write and Read a tensor to a file") {
			{
				std::ofstream out{ "C:/Develop/Small-ML-Library/MLTests/serialization/testFiles/test3.ckpt", std::ios::binary };
			...
			std::ifstream in{ "C:/Develop/Small-ML-Library/MLTests/serialization/testFiles/test3.ckpt", std::ios::binary };
	...
	TEST_CASE("Checkpoint Tests") {
		SUBCASE("Save and Load model parameters") {
			...
			Checkpoint::Save(model, "C:/Develop/Small-ML-Library/MLTests/serialization/testFiles/checkpointTest2.ckpt");
			...
			Checkpoint::Load(model2, "C:/Develop/Small-ML-Library/MLTests/serialization/testFiles/checkpointTest2.ckpt");
		...
		SUBCASE("Save and Load optimizer") {
			...
			Checkpoint::Save(model, "C:/Develop/Small-ML-Library/MLTests/serialization/testFiles/checkpointTest3.ckpt", &opt);
			...
			Checkpoint::Load(model2, "C:/Develop/Small-ML-Library/MLTests/serialization/testFiles/checkpointTest3.ckpt", &opt2);
		...
		SUBCASE("Save and Load learning rate scheduler") {
			...
			Checkpoint::Save(model, "C:/Develop/Small-ML-Library/MLTests/serialization/testFiles/checkpointTest4.ckpt", &opt, &scheduler);
			...
			Checkpoint::Load(model2, "C:/Develop/Small-ML-Library/MLTests/serialization/testFiles/checkpointTest4.ckpt", &opt2, &scheduler2);
		...
		SUBCASE("Save and Load training state") {
			...
			Checkpoint::Save<float>(model, "C:/Develop/Small-ML-Library/MLTests/serialization/testFiles/checkpointTest5.ckpt", nullptr, nullptr, &state);

			Trainer<float> trainer2{ model, opt, lossFn };

			auto state2 = trainer2.GetState();

			Checkpoint::Load<float>(model, "C:/Develop/Small-ML-Library/MLTests/serialization/testFiles/checkpointTest5.ckpt", nullptr, nullptr, &state2);
