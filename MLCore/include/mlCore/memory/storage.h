...
namespace MLCore::Memory {
	...
	/// <summary>
	/// Allocates memory for a specified number of elements using the provided arena allocator and returns a Storage representing the allocated buffer.
	/// </summary>
	...
	/// <returns>A Storage constructed from the allocated raw pointer and the element count (the buffer pointer and its size).</returns>
	template <typename T>
