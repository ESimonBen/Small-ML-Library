...
namespace MLCore::NN {
	...
	inline Conv1DLayer<T>::Conv1DLayer(size_t inChannels, size_t outChannels, size_t kernelLength, size_t stride,
		...
		: m_Kernel(Utils::Shape{outChannels, inChannels, kernelLength}), m_Bias(Utils::Shape{outChannels}),
	...
	template <typename T>
	inline TensorCore::Tensor<T> Conv1DLayer<T>::Forward(const TensorCore::Tensor<T>& input) {
	...
	inline Conv2DLayer<T>::Conv2DLayer(size_t inChannels, size_t outChannels, size_t kernelHeight, size_t kernelWidth,
		...
		: m_Kernel(Utils::Shape{outChannels, inChannels, kernelHeight, kernelWidth}), m_Bias(Utils::Shape{outChannels}),
	...
	template <typename T>
	inline TensorCore::Tensor<T> Conv2DLayer<T>::Forward(const TensorCore::Tensor<T>& input) {
	...
	inline Conv3DLayer<T>::Conv3DLayer(size_t inChannels, size_t outChannels, size_t kernelDepth, size_t kernelHeight, size_t kernelWidth,
									   ...
									   InitType kernelInit, InitType biasInit)
		: m_Kernel(Utils::Shape{outChannels, inChannels, kernelDepth, kernelHeight, kernelWidth}), m_Bias(Utils::Shape{outChannels}),
	...
	template <typename T>
	inline TensorCore::Tensor<T> Conv3DLayer<T>::Forward(const TensorCore::Tensor<T>& input) {
