/// maxPoolingLayers.inl
#include <mlCore/operations/pooling/pooling.h>

namespace MLCore::NN {
	template <typename T>
	inline MaxPool1DLayer<T>::MaxPool1DLayer(size_t filterLength, size_t stride, size_t padding, size_t dilation, bool ceilMode)
	...
	template <typename T>
	inline MaxPool3DLayer<T>::MaxPool3DLayer(size_t filterDepth, size_t filterHeight, size_t filterWidth,
