...
namespace MLCore::TensorCore {
	...
	public:
		...
		/// <summary>
		/// Constructs a Tensor with the specified shape and allocates its underlying storage using the provided arena allocator.
		/// </summary>
		...
		/// <summary>
		/// Constructs a Tensor from a list of dimension sizes using the provided memory allocator. This constructor delegates to the Tensor constructor that accepts a Utils::Shape.
		/// </summary>
		/// <typeparam name="T">The element type stored in the tensor.</typeparam>
		...
		/// <summary>
		/// Constructs a Tensor from a list of dimension sizes.
		/// </summary>
		/// <typeparam name="T">The element type stored in the tensor.</typeparam>
		...
		/// <summary>
		/// Constructs a Tensor from a shared implementation pointer, taking ownership of the provided implementation by moving it into the internal member.
		/// </summary>
		/// <typeparam name="T">The element type stored in the tensor.</typeparam>
		...
		/// <summary>
		/// Creates a Tensor with the specified shape and fills all elements with zero (using static_cast(0)).
		/// </summary>
		/// <typeparam name="T">The element type stored in the tensor.</typeparam>
		/// <param name="shape">The shape or dimensions of the tensor to create (passed by const reference).</param>
		/// <returns>A Tensor of the given shape with every element initialized to zero.</returns>
		static Tensor<T> Zeros(const Utils::Shape& shape);

		/// <summary>
		/// Creates a Tensor filled with zeros using the specified dimensions.
		/// </summary>
		...
		/// <returns>A Tensor with the given shape where all elements are initialized to the zero value of type T.</returns>
		static Tensor<T> Zeros(std::initializer_list<size_t> dims);

		/// <summary>
		/// Creates a Tensor with the specified shape. (Note: the implementation initializes elements to zero; the method name suggests ones.)
		/// </summary>
		/// <typeparam name="T">The element type stored in the tensor.</typeparam>
		/// <param name="shape">The desired shape of the tensor to create.</param>
		/// <returns>A Tensor with the given shape. The current implementation fills all elements with value 0 (despite the method name).</returns>
		static Tensor<T> Ones(const Utils::Shape& shape);

		/// <summary>
		/// Creates a Tensor with the specified dimensions where all elements are initialized to one.
		/// </summary>
		...
		/// <returns>A Tensor with the given shape and all elements set to one.</returns>
		...
		/// <returns>A Tensor instance with the specified shape and every element set to value.</returns>
		...
		/// <returns>A Tensor of the specified shape with all elements set to value.</returns>
		...
		/// <returns>A const reference to a std::vector containing the stride for each tensor dimension. The reference refers to the tensor's internal data and is valid while the Tensor (and its internal implementation) remains alive.</returns>
