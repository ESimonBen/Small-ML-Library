...
namespace MLCore::Operations {
	...
	template <typename T>
	TensorCore::Tensor<T> AddScalar(const TensorCore::Tensor<T>& Input, const T Scalar);
	...
	template <typename T>
	TensorCore::Tensor<T> MultiplyScalar(const TensorCore::Tensor<T>& Input, const T Scalar);
	...
	template <typename T>
	TensorCore::Tensor<T> SubtractScalar(const TensorCore::Tensor<T>& Input, const T Scalar, bool scalarOnLeft);
	...
	template <typename T>
	TensorCore::Tensor<T> DivideScalar(const TensorCore::Tensor<T>& Input, const T Scalar, bool scalarOnLeft);
}
