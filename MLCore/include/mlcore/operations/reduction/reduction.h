...
namespace MLCore::Operations {
	...
	template <typename T>
	TensorCore::Tensor<T> SumAll(const TensorCore::Tensor<T>& A);
	...
	template <typename T>
	TensorCore::Tensor<T> MeanAll(const TensorCore::Tensor<T>& A);
	...
	template <typename T>
	TensorCore::Tensor<T> MaxAll(const TensorCore::Tensor<T>& A);
	...
	template <typename T>
	TensorCore::Tensor<T> MinAll(const TensorCore::Tensor<T>& A);
	...
	template <typename T>
	TensorCore::Tensor<T> AxisSum(const TensorCore::Tensor<T>& A, size_t axis, bool keepDims = false);
	...
	template <typename T>
	TensorCore::Tensor<T> AxisMean(const TensorCore::Tensor<T>& A, size_t axis, bool keepDims = false);
	...
	template <typename T>
	TensorCore::Tensor<T> AxisMax(const TensorCore::Tensor<T>& A, size_t axis, bool keepDims = false);
	...
	template <typename T>
	TensorCore::Tensor<T> AxisMin(const TensorCore::Tensor<T>& A, size_t axis, bool keepDims = false);
}
