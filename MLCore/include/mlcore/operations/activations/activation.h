...
namespace MLCore::Operations {
	...
	template <typename T>
	TensorCore::Tensor<T> Softmax(const TensorCore::Tensor<T>& A); /// Should not be used in actual machine learning contexts, debugging / teaching moment for me only
	...
	template <typename T>
	TensorCore::Tensor<T> AxisLogSoftmax(const TensorCore::Tensor<T>& A, size_t axis); /// Because of numerical stability, apparently
}
